    ...
    public class Rectangle : FillShape
    {
        ...
        public override GraphicsPath GraphicsPath
        {
            get
            {
                ...
                {
                    path.AddRectangle(new RectangleF(Begin.X, Begin.Y, End.X - Begin.X, End.Y - Begin.Y));
                }
                else if (Begin.X < End.X && End.Y < Begin.Y)
                {
                    path.AddRectangle(new RectangleF(Begin.X, End.Y, End.X - Begin.X, Begin.Y - End.Y));
                }
                else if (End.X < Begin.X && Begin.Y < End.Y)
                {
                    path.AddRectangle(new RectangleF(End.X, Begin.Y, Begin.X - End.X, End.Y - Begin.Y));
                }
                else
                {
                    path.AddRectangle(new RectangleF(End.X, End.Y, Begin.X - End.X, Begin.Y - End.Y));
                }
                return path;
            }
        }
